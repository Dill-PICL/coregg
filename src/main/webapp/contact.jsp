...
<div class="container">
    ...
    <div class="jumbotron">
        <h4 style="text-align: center;">Please report any questions about method of this tool to the <a href="mailto:triffid@iastate.edu">Carolyn J Dill
        </a></h4>
        <h4 style="text-align: center;">If you want to report a bug, Email the <a href="mailto:gaoyike@gmail.com">Chenguang He</a></h4>
    </div>
</div>
